	...
	*/
	...
	private:
		...
		*/
		...
		/*!
		@brief 初期化
		ここに、gnuplot.exeまでのディレクトリ構成を示す
		*/
		void Ini()
		{
			Fp = _popen("C:\\Users\\mitsuki\\Documents\\software\\gnuplot\\gnuplot.exe", "w");
	...
	public:
		...
		*/
		...
		視点を設定
		*/
		void SetView(double rot1, double rot2 , double scale , double scaleZ)
		{
			Command("set view %lf,%lf,%lf,%lf", rot1,rot2,scale,scaleZ);
		}
		/*!
		@brief ラベルをセット
		...
		*/
		...
		void ReverseX()
		{
			Command("set xrange [] reverse ");
		}

		void ReverseY()
		{
			Command("set yrange [] reverse ");
		}
